...
azure_function_endpoint {
  function_id = "/subscriptions/${var.subscription_id}/resourceGroups/rg-dev-projeto/providers/Microsoft.Web/sites/rg-dev-projeto-func-validate/functions/ValidateFakeData"
}
